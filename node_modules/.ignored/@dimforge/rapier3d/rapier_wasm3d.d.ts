...
* @returns {number | undefined}
*/
  createCollider(shape: RawShape, translation: RawVector, rotation: RawRotation, density: number | undefined, friction: number, restitution: number, frictionCombineRule: number, restitutionCombineRule: number, isSensor: boolean, collisionGroups: number, solverGroups: number, activeCollisionTypes: number, activeHooks: number, activeEvents: number, parent: number, bodies: RawRigidBodySet): number | undefined;
/**
...
* @param {RawJointSet} joints
*/
  removeRigidBody(handle: number, islands: RawIslandManager, bodies: RawRigidBodySet, colliders: RawColliderSet, joints: RawJointSet): void;
/**
* @param {number} handle
* @param {RawIslandManager} islands
* @param {RawRigidBodySet} bodies
* @param {RawColliderSet} colliders
*/
  removeCollider(handle: number, islands: RawIslandManager, bodies: RawRigidBodySet, colliders: RawColliderSet): void;
}
/**
*/
...
* @returns {number}
*/
  rbBodyStatus(handle: number): number;
/**
